...
module.exports = {
  "rules": {
    ...
    "guard-for-in": 0, // 在 for in 表达式中需要调用 hasOwnProperty 来判断是否为自有的属性
    ...
    "max-lines": [2, {"max": 1800, "skipBlankLines": true, "skipComments": true}], // 指定每个文件最大行
