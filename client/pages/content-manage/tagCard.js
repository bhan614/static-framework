...
class TagCard extends Component {
  ...
  handleSubmit(e) {
    ...
    form.validateFieldsAndScroll(( err, values ) => {
      if ( !err ) {
        ...
        appActions.loading(true).then(() => {
          return contentManageActions.addTag({
            ...values
          })
          .then(() => {
            appActions.loading(false);
  ...
  getArea() {
    return () => document.getElementById('tagCard-area')
  }
  ...
  render() {
    ...
    return (
      <Modal
        ...
        footer={null}
      >
        <Form onSubmit={this.handleSubmit} style={{paddingTop: '20px'}} id="tagCard-area">
          <FormItem
          {...formItemLayout}
          label='城市'
          >
          ...
          >
            { getFieldDecorator( 'tag', {
              initialValue: editData && editData.tag ? editData.tag : ''
            } )(
...
export default connect( mapStateToProps, mapDispatchToProps )(Form.create()( TagCard ))
