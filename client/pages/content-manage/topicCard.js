...
class TopicCard extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      subTitleLength: props.editData && props.editData.summary && props.editData.summary.length || '0',
    }
    ...
    return (
      ...
      >
        ...
        >
            ...
            <TextArea placeholder="不超过30个字" style={{ width: '80%', marginRight: '10px' }} onChange={this.onSubTitleChange} />
          ) }
        ...
        >
            ...
            <Upload
             ...
             >
              {
                 this.state.imgUrl ?
                   <img src={this.state.imgUrl} alt="图片加载失败" className="avatar" onError={this.ImgLoadError}/> :
        ...
        >
          ...
          </FormItem>
          {
            ...
            >
                ...
                initialValue: editData ? editData.topicUrl : ''
              } )(
                <Input />
              ) }
              </FormItem> : null
        ...
        >
         ...
         >
            ...
            {
              this.state.type === '1' ? <Button style={{float: 'right', marginRight: '10px'}} type='primary' size='default' onClick={this.handleShowIframe} >预览</Button> : null
            }
          </FormItem>
          {
...
export default connect( mapStateToProps, mapDispatchToProps )(Form.create()( TopicCard ))
