...
import ProductCard from './productDecorateCard'
import ProductDetail from './productDecorateDetail';
...
class Product extends Component {
  ...
  componentWillMount() {
    ...
    appActions.loading(true).then(() => {
      return Promise.all([
        websiteManageActions.getDecorateList({
          pageNum,
          pageSize,
          cityCode
        }),
  ...
  render() {
    ...
    const productList = websiteManage.get('decorateList') && websiteManage.get('decorateList');
