    ...
    form.validateFieldsAndScroll(( err, values ) => {
      if ( !err ) {
        ...
        appActions.loading(true).then(() => {
          return websiteManageActions.addDecorate({
            id,
            ...values
          })
          .then(() => {
            return websiteManageActions.getDecorateList({
              pageNum,
              pageSize,
              cityCode,
              status
    ...
    return (
      ...
      >
        ...
        >
            ...
            rules: [{ required: true, message: '请输入产品特点' }],
            initialValue: editData ? editData.features : ''
          } )(
            <Input />
          ) }
          </FormItem>
        ...
        >
            ...
            rules: [{ required: true, message: '请输入额度费用额度' }],
            initialValue: editData ? editData.quota : ''
          } )(
            <Input />
          ) }
          </FormItem>
        ...
        >
            ...
            rules: [{ required: true, message: '请输入额度费用期限' }],
            initialValue: editData ? editData.term : ''
          } )(
            <Input />
          ) }
          </FormItem>
