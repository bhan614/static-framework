...
import ProductCard from './productLiveCard'
import ProductDetail from './productLiveDetail';
...
class Product extends Component {
  ...
  handleChangeState(id, s, code) {
    return () => {
      const { appActions, contentManageActions, contentManage, websiteManageActions, websiteManage } = this.props;
      const { pageSize, pageNum, cityCode, name, status } = this.state;
  ...
  handlePaginationChange(page, pageSize) {
    ...
    const { appActions, contentManageActions, websiteManageActions } = this.props;
    appActions.loading(true).then(() => {
      return websiteManageActions.getLiveList({
        pageNum: page,
        pageSize,
        cityCode,
        productName: name,
  ...
  render() {
    ...
    const productList = websiteManage.get('liveList') && websiteManage.get('liveList');
