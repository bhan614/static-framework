      ...
      >
        <div className="detail-container">
          ...
          <Row>
            <Col span={4}></Col>
            <Col span={4}>产品特点:</Col>
            <Col span={16}>{editData && editData.features && editData.features}</Col>
          </Row>
          <Row>
            <Col span={4}></Col>
            <Col span={4}>额度费用额度:</Col>
            <Col span={16}>{editData && editData.quota && editData.quota}</Col>
          </Row>
          <Row>
            <Col span={4}></Col>
            <Col span={4}>额度费用期限:</Col>
            <Col span={16}>{editData && editData.term && editData.term}</Col>
          </Row>
          <Row>
            <Col span={4}></Col>
            <Col span={4}>状态:</Col>
